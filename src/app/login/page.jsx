  ...
  return (
    <div className='bg-slate-900 w-full flex flex-col gap-8 items-center justify-center h-[89vh] overflow-y-hidden text-white'>
      ...
      <h1 className='text-3xl font-bold text-white'> </h1>
        ...
        <form className={` sm:w-[400px] w-[300px] flex flex-col gap-6 rounded-md shadow-sm items-center justify-center px-5 py-5 bg-slate-900 ${styles.container} shadow-slate-950`}>
